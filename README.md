...
React JS is a virtual DOM and it tries to solve the hassles of dealing with dom api. Instead of the webpage reloading everything on page instead it only loads the thing that change.

1. Describe component state.
State keeps track of what is currently changing

1. Describe props.
Props are keys from a object that is used in a component 

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
side effects are something that you want to happen after something changes. To sync effect you put the variable inside the second argument.
